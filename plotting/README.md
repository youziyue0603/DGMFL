...
- `data/main_benchmark.csv`, `data/main_summary.csv`, and `data/method_summary.csv`:
  six-family benchmark results.
- `data/paired_statistics.csv` and `data/convergence_curves.csv`: paired tests and convergence records.
...
- `data/sensitivity.csv`, `data/fidelity_robustness.csv`, `data/stress_tests.csv`,
  `data/split_robustness.csv`, and `data/scalability.csv`: sensitivity and robustness records.
- `data/compute_profile.csv`: recorded computational cost.
